...
该版本为1.6.0可执行（修改）版，因重复率与数据量等原因为适应绝大部分数据，编译时
将ReadGroupStatsUtil.cpp中“static const float minMaxFrac(0.9f)”修改为“0.1”。   
...
[UserGuide]:https://github.com/Illumina/manta/blob/master/docs/userGuide/README.md
