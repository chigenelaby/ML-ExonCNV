...
def pgene():
	...
	midgenelist = {}
	#print(file1)
	# file1 = os.path.join(os.path.dirname(os.path.abspath(__file__)),"config","positivegenelist.txt")
	file1 = os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, 'docs', 'positivegenelist.txt')
	print(file1)
...
def whiteregion():
	...
	focus1 = os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, 'docs',"gene_attentions.txt_1")
	fp1 = open(focus1,"r")
	f1 = {}
	f2 = {}
	for i,f1lines in enumerate(fp1):
		...
		key = "_".join(f1line[:3])
		f1[key] = f1line[3]	
	focus2 = os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, 'docs',"gene_attentions.txt_2")
	fp2 = open(focus2,"r")
			...
			if(balance >= 0.08):
				...
				if(reliresult == "特别可靠"):
					if(freq < 0.001):
						...
						#line = reline + ["R1a"]
						setredict[key] = "R1a"
					if(freq >= 0.001 and freq < 0.005 and (ecount == 1 or length <300) and (inheritance == 1 or gene_name in genelist)):
						#reline = addreportloic(infosi,line)
						#line = reline + ["R1b"]
						setredict[key] = "R1b"
					if(freq >= 0.001 and freq < 0.005 and (ecount >= 2 and length >=300) and gene_name in genelist):
						#reline = addreportloic(infosi,line)
						#line = reline + ["R1c"]
						setredict[key] = "R1c"
					if(freq >= 0.001 and freq < 0.005 and (ecount >= 2 and length >=300) and gene_name not in genelist):
						setredictlow[key] = "R1c"

					if(freq < 0.05 and freq >= 0.005 and gene_name in genelist):
						#reline = addreportloic(infosi,line)
						#line = reline + ["R1d"]
						setredict[key] = "R1d"
				elif(reliresult == "相对可靠"):
					if(balance < 0.02):
						if(freq < 0.001 and (ecount == 1 or length <300) and ((inheritance == 1 and gene_name in midgenelist) or gene_name in midgenelist)):
							#if((ecount == 1 or length <300) and (inheritance == 1 or gene_name in genelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R2a"]
							setredict[key] = "R2a"
							#if((ecount >= 2 and length >=300)):
						elif(freq < 0.001 and (ecount >= 2 and length >=300) and gene_name in midgenelist):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R2b"]
							setredict[key] = "R2b"
						elif(freq < 0.001 and (ecount >= 2 and length >=300) and gene_name not in midgenelist):
							setredictlow[key] = "R2b"

						elif(freq < 0.05 and freq >= 0.001 and (ecount == 1 or length <300) and ((inheritance == 1 and gene_name in midgenelist) or gene_name in hgenelist)):
						...
						elif(freq < 0.05 and freq >= 0.001 and (ecount == 2 and length >=300) and (inheritance == 1 or gene_name in genelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R2d"]
							#setredict[key] = "R2d"
						...
						elif(freq >= 0.001 and freq < 0.005 and (ecount >= 3 and length >=300) and gene_name in midgenelist):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R2e"]
							setredict[key] = "R2e"
						elif(freq >= 0.001 and freq < 0.005 and (ecount >= 3 and length >=300) and gene_name not in midgenelist):
							setredictlow[key] = "R2e"
						elif(freq < 0.05 and freq >= 0.005 and (ecount >= 3 and length >=300) and (gene_name in genelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R2f"]
							setredict[key] = "R2f"
						else:
					...
					if(balance >= 0.02 and balance < 0.04):
						if(freq < 0.001 and (ecount < 3 or length <300) and ((inheritance == 1 and gene_name in midgenelist )or gene_name in midgenelist)):
							#if((ecount < 3 or length <300) and (inheritance == 1 or gene_name in genelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R3a"]
							setredict[key] = "R3a"
							#if(ecount >= 3):
						elif(freq < 0.001 and ecount >= 3 and gene_name in midgenelist):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R3b"]
							setredict[key] = "R3b"
						elif(freq < 0.001 and ecount >= 3 and gene_name not in midgenelist):
							setredictlow[key] = "R3b"
						elif(freq >= 0.001 and freq < 0.005 and (ecount == 1 or length <300) and ((inheritance == 1 and gene_name in midgenelist ) or gene_name in hgenelist)):
							#if((ecount == 1 or length <300) and (inheritance == 1 or gene_name in hgenelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R3c"]
							setredict[key] = "R3c"
							#if((ecount >= 2 and length >=300) and ( gene_name in genelist or gene_name in genelist)):
						elif(freq >= 0.001 and freq < 0.005 and (ecount >= 2 and length >=300) and (inheritance == 1 or gene_name in genelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R3d"]
							if(gene_name in midgenelist):
								setredict[key] = "R3d"
						...
						elif(freq < 0.05 and freq >= 0.005 and (ecount < 3 and length >=300) and gene_name in hgenelist):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R3e"]
							setredict[key] = "R3e"
						elif(freq < 0.05 and freq >= 0.005 and (ecount >= 3 and length >=300) and gene_name in genelist):
					...
					if(balance >= 0.04 and balance < 0.08):
						if(freq < 0.001 and (ecount < 3 or length < 300) and gene_name in hgenelist):
						...
						elif(freq < 0.001 and (ecount >= 3 and length >= 300)and (inheritance == 1 or gene_name in genelist)):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R4b"]
							setredict[key] = "R4b"
							...
							#line = reline + ["R4c"]
							setredict[key] = "R4c"
						elif(freq < 0.05 and freq >= 0.005 and gene_name in hgenelist):
							#reline = addreportloic(infosi,line)
							#line = reline + ["R4d"]
							setredict[key] = "R4d"
						else:
...
name = transformtable(sys.argv[2],sys.argv[1],sys.argv[3])

fp = open(os.path.dirname(sys.argv[1])+"/format_gene_info_back.txt","r")
setredict,setredictlow = judgeal(os.path.dirname(sys.argv[1])+"/format_gene_info_table.txt")
#print(whitelistdict)
fw = open(os.path.dirname(sys.argv[1])+"/format_gene_info.txt","w")
